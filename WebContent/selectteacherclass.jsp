...
<html>
    ...
    <head>
        ...
        function selectclazz() {
			...
			window.location.href="selectteacherclass.jsp?name="+teachername+"";
		}
            ...
            <div class="row-fluid">
                ...
                <div class="span10" id="content">
					<div class="alert alert-success">
                            ...
                            <h4>请选择您要查询的教师姓名 </h4>
                            <br>
                        	<select onchange="selectclazz()" id="teachername">
                        	<% 
                        	String sqlselecttaerchername="SELECT teachername FROM teacher";
                        	List<Map<String, Object>> namelist = DBUtils.query(sqlselecttaerchername);
                        	for (Map<String, Object> teachernamelist : namelist) {
                        		%>
                        		<option value="<%=teachernamelist.get("teachername") %>"><%=teachernamelist.get("teachername") %></option>
                        		<%
                        	}
                        	%>
