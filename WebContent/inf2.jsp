...
<html>
    ...
    <head>
        ...
        function root(userid,password) {
        	var newpassword=window.prompt("请输入你修改后的密码",password);
     	   if(newpassword==password||newpassword==""||newpassword==null){
           		return;
           	}
     	   else{
        		window.location.href="updatepassword2?newpassword="+newpassword+"&userid="+userid+"";
     	   }
		}
                ...
                <div class="container-fluid">
                   ...
                   <div class="nav-collapse collapse">
                        <ul class="nav pull-right">
                            ...
                            name1=new String(name1.trim().getBytes("ISO-8859-1"), "UTF-8");
                            System.out.println("inf界面测试点一"+name1);
                            %>
                                <a href="#" role="button" class="dropdown-toggle" data-toggle="dropdown"> <i class="icon-user"></i><%=name1 %><i class="caret"></i>
            ...
            <div class="row-fluid">
                <div class="span2" id="sidebar">
                    <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
                         <li class="active">
                            <a href="formtoindex2?name=<%=name1%>"><i class="icon-chevron-right"></i> 首页</a>
                        </li>
                        <li>
                            <a href="formteacher.jsp?name=<%=name1%>"><i class="icon-chevron-right"></i> 查看我的课表</a>
                        </li>
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
                                      ...
                                      for (Map<String, Object> map : resultlist) {
                                       ...
                                       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                          <a onclick="root(<%=map.get("userid") %>,'<%=map.get("password")%>')"><font color="red">修改密码</font></a>
                                          </label>
