...
<html>
    ...
    <head>
        <title>日历页面_免费简洁响应式Bootstrap后台主题模板BootAdmin - JS代码网</title>
            ...
            <div class="row-fluid">
                <div class="span2" id="sidebar">
                    <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
                        <li class="active">
                            <a href="index2.jsp"><i class="icon-chevron-right"></i> 首页</a>
                        </li>
                        <li>
                            <a href="teacherclaa.jsp"><i class="icon-chevron-right"></i> 查看我的课表</a>
                        </li>
                    </ul>
                </div>
                <!--/span-->
